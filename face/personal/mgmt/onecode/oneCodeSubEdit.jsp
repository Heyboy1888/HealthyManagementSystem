...
<ls:body>
	<ls:form name="oneAddrOneCodeSubEditForm" id="oneAddrOneCodeSubEditForm">
		<ls:text visible="false" name="companyId" property="companyId" />
		<ls:text visible="false" name="certPic" property="certPic" />
		<ls:text visible="false" name="storePic" property="storePic" />
		<ls:text visible="false" name="busPic" property="busPic" />
		<ls:text visible="false" name="recordId" property="recordId" />
		<table class="tab_search" width="100%">
			...
			<tr>
				<td><ls:label ref="companySubName" text="子码具体地址" needColon="true" /></td>
				<td><ls:text id="companySubName" type="text" name="companySubName"
						property="companySubName" readOnly="true" /></td>
				<td>&nbsp;</td>

				<td><ls:label ref="createPerson" text="子创建人" needColon="true" /></td>
				<td><ls:text id="createPerson" type="text" name="createPerson" 
						 property="createPerson" readOnly="true" /></td>
				<td>&nbsp;</td>

				<td><ls:label ref="createType" text="子码类型" needColon="true" /></td>
				<td>
					<ls:select name="createType" id="createType"  property="createType"   readOnly="true" >
						<ls:options property="typeBoList" scope="request" text="name" value="value"/>
					</ls:select>
				<td>
				<td>&nbsp;</td>
			</tr>
			...
			<tr>
				<td><ls:label ref="companyStatus" text="单位子码状态" needColon="true" /></td>	
				<td>
	...
	<ls:script>
			window.oneAddrOneCodeSubEditForm = oneAddrOneCodeSubEditForm;
			...
			function doSave(){
				if (!oneAddrOneCodeSubEditForm.valid()) {return;}
				var tipMsg;
				var url = "~/OneCodeController/saveOrUpdate";
				var params = oneAddrOneCodeSubEditForm.getFormData();
