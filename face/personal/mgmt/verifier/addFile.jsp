...
<ls:body>
			...
			<tr>
				...
				<td colspan="6">
					<div style="float: right">
						<ls:button text="上传" 	 	onclick="doSave" />
	...
	<ls:script>
		...
		         return;    
		     } 
			templetAddForm.submit('~/verifierMgmtController/fileImport',function(data){
				...
				if(flag){
					...
					//LS.message("info","文件导入成功,导入总数量:"+count.allCount+"个，增加"+count.scuuessCount+"个，更新"+count.updateCount+"个");
