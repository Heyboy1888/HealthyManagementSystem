...
public interface ITCHealthCommunityInfoService {
	...
	List<TCHealthCommunityInfo> selectByExample(
			TCHealthCommunityInfoCriteria example);

	TCHealthCommunityInfo selectByPrimaryKey(String id);

	int updateByExampleSelective(@Param("record") TCHealthCommunityInfo record,
			@Param("example") TCHealthCommunityInfoCriteria example);

	int updateByExample(@Param("record") TCHealthCommunityInfo record,
			@Param("example") TCHealthCommunityInfoCriteria example);
