...
public class BackgroundApplier implements CssApplier {
    ...
    public void apply(HSSFCell cell, HSSFCellStyle cellStyle, Map<String, String> style) {
    	...
    	if (StringUtils.isNotBlank(bgColor)) {
    		...
    		if("#fce4d6".equals(bgColor)){
    			cellStyle.setFillForegroundColor((short)63);
    		}else if ("#ddebf6".equals(bgColor)) {
    			cellStyle.setFillForegroundColor((short)62);
			}else if ("#e2efda".equals(bgColor)) {
    			cellStyle.setFillForegroundColor((short)61);
			}
    		else{
